<?php
/* Smarty version 3.1.30, created on 2017-08-03 01:00:32
  from "D:\wamp\www\BaiJiaHao\application\views\home\index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59820530139148_78560495',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '84b5c3c5f6918330a78e39c21e54c887003dbbbf' => 
    array (
      0 => 'D:\\wamp\\www\\BaiJiaHao\\application\\views\\home\\index.html',
      1 => 1501693224,
      2 => 'file',
    ),
  ),
...
function content_59820530139148_78560495 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_truncate')) require_once 'D:\\wamp\\www\\BaiJiaHao\\libs\\smarty-3.1.30\\libs\\plugins\\modifier.truncate.php';
?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['v']->value['title'],20,'……');?>
													...
													<div class="media-text">
														<a href="?c=index&m=authorArticle"><?php echo $_smarty_tpl->tpl_vars['artAuthorName']->value[$_smarty_tpl->tpl_vars['k']->value];?>
</a>
...
" class="img-circle" style="height: 99px;width: 99px; padding: 12px;">
										...
										<div class="media-author-part col-lg-10 col-md-10 col-sm-10 col-xs-10">
											<a href="?c=index&m=authorArticle" class="media-author-part-a1" ><?php echo $_smarty_tpl->tpl_vars['artAuthorNameView']->value[$_smarty_tpl->tpl_vars['k']->value];?>
 </a>
											<a href="?c=index&m=authorArticle" class="media-author-part-a2" ><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['artAuthorLeadView']->value[$_smarty_tpl->tpl_vars['k']->value],10);?>
</a>
											<a href="?c=index&m=authorArticle" class="media-author-part-a3" ><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['v']->value['title'],20);?>
</a>
										</div>
									</div>
								</li>
									...
									<div class="media-body">
										...
										<div style="margin-left: 25px;margin-bottom: 30px;">
											...
											<table style="width:14%;text-align: center;float:right;display: inline-block;font-size: 18px;color: #9d9d9d">
												<tr>
													<td><a id="oup" style="color: #9d9d9d; cursor: pointer;"><i id="oupi" class="fa fa-thumbs-o-up"></i></a>&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['oneArticle']->value[0]['like'];?>
</td>
													<td>&nbsp;&nbsp;|&nbsp;&nbsp;</td>
													<td><a id="odown" style="color: #9d9d9d; cursor: pointer;"><i id="oudowni" class="fa fa-thumbs-o-down"></i></a>&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['oneArticle']->value[0]['unlike'];?>
</td>
												</tr>
											</table>
										</div>
...
" class="img-circle" style="height: 90px;width: 90px; padding: 12px;">
										...
										<div class="media-author-part-1 col-lg-10 col-md-10 col-sm-10 col-xs-10">
											<a href="?c=index&m=authorArticle" class="media-author-part-a1" ><?php echo $_smarty_tpl->tpl_vars['artAuthorNameView']->value[0];?>
 </a>
											<a href="?c=index&m=authorArticle" class="media-author-part-a2" ><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['artAuthorLeadView']->value[0],10);?>
</a>
										</div>
									</div>
								</div>
